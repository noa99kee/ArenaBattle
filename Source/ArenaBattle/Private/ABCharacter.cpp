...
void AABCharacter::PostInitializeComponents()
{
	...
	if (nullptr != CharacterWidget) {
		...
		ABLOG(Warning, TEXT("CharacterWidget is null"));
	}
	*/
...
void AABCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(TEXT("Look"), this, &AABCharacter::LookUp);
...
void AABCharacter::AttackCheck()
{
	...
	bool bResult = GetWorld()->SweepSingleByChannel(HitResult, GetActorLocation(), GetActorLocation() + GetActorForwardVector() * FinalAttackRange, FQuat::Identity, ECollisionChannel::ECC_EngineTraceChannel2, FCollisionShape::MakeSphere(AttackRadius), Params);
